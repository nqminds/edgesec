...
if (BUILD_NETLINK_LIB AND NOT (BUILD_ONLY_DOCS))
  ...
  find_library(LIBNETLINK_LIB NAMES libnetlink PATHS "${LIBNETLINK_LIB_PATH}")
  if (LIBNETLINK_LIB)
    message("Found libnetlink library: ${LIBNETLINK_LIB}")
  ELSE ()
    execute_process(COMMAND bash ${CMAKE_SOURCE_DIR}/lib/compile_libnetlink.sh ${CMAKE_CURRENT_BINARY_DIR}/lib)
    find_library(LIBNETLINK_LIB NAMES libnetlink PATHS "${LIBNETLINK_LIB_PATH}")
  endif ()
