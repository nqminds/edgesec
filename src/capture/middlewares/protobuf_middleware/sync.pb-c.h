...
typedef enum {
  ...
  TDX__VOLT_API__SYNC__V1__PROTOBUF_SYNC_WRAPPER__HEADER_LOOKUP_HEADER_INDEX = 1,
  TDX__VOLT_API__SYNC__V1__PROTOBUF_SYNC_WRAPPER__HEADER_LOOKUP_HEADER_ID = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(TDX__VOLT_API__SYNC__V1__PROTOBUF_SYNC_WRAPPER__HEADER_LOOKUP__CASE)
...
#define TDX__VOLT_API__SYNC__V1__PROTOBUF_SYNC_WRAPPER__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&tdx__volt_api__sync__v1__protobuf_sync_wrapper__descriptor) \
    , {0,NULL}, TDX__VOLT_API__SYNC__V1__PROTOBUF_SYNC_WRAPPER__HEADER_LOOKUP__NOT_SET, {0} }
...
#define TDX__VOLT_API__SYNC__V1__PROTOBUF_SYNC_CONFIGURATION_HEADER__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&tdx__volt_api__sync__v1__protobuf_sync_configuration_header__descriptor) \
