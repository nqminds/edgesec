...
#define ARP__ARP_SCHEMA__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&arp__arp_schema__descriptor) \
    , (char *)protobuf_c_empty_string, 0, 0, 0, 0, 0, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string }
...
typedef void (*Arp__ArpSchema_Closure)
                 (const Arp__ArpSchema *message,
                  void *closure_data);
