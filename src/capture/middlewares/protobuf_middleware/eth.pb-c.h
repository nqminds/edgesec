...
#define ETH__ETH_SCHEMA__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&eth__eth_schema__descriptor) \
    , 0, (char *)protobuf_c_empty_string, 0, 0, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0 }
...
typedef void (*Eth__EthSchema_Closure)
                 (const Eth__EthSchema *message,
                  void *closure_data);
