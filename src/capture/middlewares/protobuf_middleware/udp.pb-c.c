...
Udp__UdpSchema *udp__udp_schema__unpack(ProtobufCAllocator *allocator,
  ...
  return (Udp__UdpSchema *)protobuf_c_message_unpack(
      &udp__udp_schema__descriptor, allocator, len, data);
}
...
static const ProtobufCFieldDescriptor udp__udp_schema__field_descriptors[5] = {
    {
        ...
        0, /* quantifier_offset */
        offsetof(Udp__UdpSchema, id), NULL, &protobuf_c_empty_string,
        0,            /* flags */
    ...
    },
    {
        ...
        0,                                               /* quantifier_offset */
        offsetof(Udp__UdpSchema, source), NULL, NULL, 0, /* flags */
        0, NULL, NULL /* reserved1,reserved2, etc */
    },
    {
        "dest", 3, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_UINT32,
        0,                                             /* quantifier_offset */
        offsetof(Udp__UdpSchema, dest), NULL, NULL, 0, /* flags */
        0, NULL, NULL /* reserved1,reserved2, etc */
    },
    {
        "len", 4, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_UINT32,
        0,                                            /* quantifier_offset */
        offsetof(Udp__UdpSchema, len), NULL, NULL, 0, /* flags */
        0, NULL, NULL /* reserved1,reserved2, etc */
    },
    {
        "check_p", 5, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_UINT32,
        0, /* quantifier_offset */
        offsetof(Udp__UdpSchema, check_p), NULL, NULL, 0, /* flags */
        0, NULL, NULL /* reserved1,reserved2, etc */
    },
};
...
static const ProtobufCIntRange udp__udp_schema__number_ranges[1 + 1] = {{1, 0},
                                                                        {0, 5}};
const ProtobufCMessageDescriptor udp__udp_schema__descriptor = {
    ...
    1,
    udp__udp_schema__number_ranges,
