...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_sqlite_5fsync_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_sqlite_5fsync_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021sqlite_sync.proto\022\nhelloworld\"\034\n\014Hello"
