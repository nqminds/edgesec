...
#define RADIUS_DEBUG(...) \
wpa_printf(MSG_DEBUG, "RADIUS SRV: " __VA_ARGS__)
#define RADIUS_ERROR(...) \
wpa_printf(MSG_ERROR, "RADIUS SRV: " __VA_ARGS__)
#define RADIUS_DUMP(...) \
wpa_hexdump(MSG_MSGDUMP, "RADIUS SRV: " __VA_ARGS__)
				       ...
				       struct radius_session *sess)
{
	...
	eloop_cancel_timeout(data->eloop, radius_server_session_remove_timeout, data, sess);
