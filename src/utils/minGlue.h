...
#define ini_openread(filename, file)                                           \
  ((*(file) = fopen((filename), "rb")) != NULL)
#define ini_openwrite(filename, file)                                          \
  ((*(file) = fopen((filename), "wb")) != NULL)
#define ini_openrewrite(filename, file)                                        \
  ((*(file) = fopen((filename), "r+b")) != NULL)
